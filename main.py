 ...
 |_| \_|   \/ \___\___/ \__,_|\___|_|
  ...
  Spymer Lite Edition (SLE)                                
            ...
            def onesend():
                ...
                logo()
                print(info)
                print('Введите телефон (без +):')
                phone = input(Fore.BLUE+"Spymer Lite > "+Style.RESET_ALL)
                try:
                    if int(phone):
                        print('Введите количество кругов:')
                        count = input(Fore.BLUE+"Spymer Lite > "+Style.RESET_ALL)
                        try:
                            if int(count):
                                count=int(count)
                                make7phone()
            ...
            def main():
                ...
                while True:
                    ...
                    logo()
                    print(info)
                    print("Прокси: "+Fore.BLUE+"{}".format(proxy)+Style.RESET_ALL)
                    print("1) СМС спамер.")
                    print("2) Выход.")
